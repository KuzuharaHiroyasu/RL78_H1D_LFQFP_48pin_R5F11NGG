...
#define _0000_TAU0_CKM3_fCLK_8                (0x0000U) /* ckm3 - fCLK/2^8 */
#define _1000_TAU0_CKM3_fCLK_10               (0x1000U) /* ckm3 - fCLK/2^10 */
#define _2000_TAU0_CKM3_fCLK_12               (0x2000U) /* ckm3 - fCLK/2^12 */
#define _3000_TAU0_CKM3_fCLK_14               (0x3000U) /* ckm3 - fCLK/2^14 */
/* Operating mode and clear mode selection (PRS021,PRS020) */
#define _0000_TAU0_CKM2_fCLK_1                (0x0000U) /* ckm2 - fCLK/2^1 */
#define _0100_TAU0_CKM2_fCLK_2                (0x0100U) /* ckm2 - fCLK/2^2 */
#define _0200_TAU0_CKM2_fCLK_4                (0x0200U) /* ckm2 - fCLK/2^4 */
#define _0300_TAU0_CKM2_fCLK_6                (0x0300U) /* ckm2 - fCLK/2^6 */
/* Operating mode and clear mode selection (PRS013,PRS012,PRS011,PRS010) */
#define _0000_TAU0_CKM1_fCLK_0                (0x0000U) /* ckm1 - fCLK */
#define _0010_TAU0_CKM1_fCLK_1                (0x0010U) /* ckm1 - fCLK/2^1 */
#define _0020_TAU0_CKM1_fCLK_2                (0x0020U) /* ckm1 - fCLK/2^2 */
#define _0030_TAU0_CKM1_fCLK_3                (0x0030U) /* ckm1 - fCLK/2^3 */
#define _0040_TAU0_CKM1_fCLK_4                (0x0040U) /* ckm1 - fCLK/2^4 */
#define _0050_TAU0_CKM1_fCLK_5                (0x0050U) /* ckm1 - fCLK/2^5 */
#define _0060_TAU0_CKM1_fCLK_6                (0x0060U) /* ckm1 - fCLK/2^6 */
#define _0070_TAU0_CKM1_fCLK_7                (0x0070U) /* ckm1 - fCLK/2^7 */
#define _0080_TAU0_CKM1_fCLK_8                (0x0080U) /* ckm1 - fCLK/2^8 */
#define _0090_TAU0_CKM1_fCLK_9                (0x0090U) /* ckm1 - fCLK/2^9 */
#define _00A0_TAU0_CKM1_fCLK_10               (0x00A0U) /* ckm1 - fCLK/2^10 */
#define _00B0_TAU0_CKM1_fCLK_11               (0x00B0U) /* ckm1 - fCLK/2^11 */
#define _00C0_TAU0_CKM1_fCLK_12               (0x00C0U) /* ckm1 - fCLK/2^12 */
#define _00D0_TAU0_CKM1_fCLK_13               (0x00D0U) /* ckm1 - fCLK/2^13 */
#define _00E0_TAU0_CKM1_fCLK_14               (0x00E0U) /* ckm1 - fCLK/2^14 */
#define _00F0_TAU0_CKM1_fCLK_15               (0x00F0U) /* ckm1 - fCLK/2^15 */
/* Operating mode and clear mode selection (PRS003,PRS002,PRS001,PRS000) */
#define _0000_TAU0_CKM0_fCLK_0                (0x0000U) /* ckm0 - fCLK */
#define _0001_TAU0_CKM0_fCLK_1                (0x0001U) /* ckm0 - fCLK/2^1 */
#define _0002_TAU0_CKM0_fCLK_2                (0x0002U) /* ckm0 - fCLK/2^2 */
#define _0003_TAU0_CKM0_fCLK_3                (0x0003U) /* ckm0 - fCLK/2^3 */
#define _0004_TAU0_CKM0_fCLK_4                (0x0004U) /* ckm0 - fCLK/2^4 */
#define _0005_TAU0_CKM0_fCLK_5                (0x0005U) /* ckm0 - fCLK/2^5 */
#define _0006_TAU0_CKM0_fCLK_6                (0x0006U) /* ckm0 - fCLK/2^6 */
#define _0007_TAU0_CKM0_fCLK_7                (0x0007U) /* ckm0 - fCLK/2^7 */
#define _0008_TAU0_CKM0_fCLK_8                (0x0008U) /* ckm0 - fCLK/2^8 */
#define _0009_TAU0_CKM0_fCLK_9                (0x0009U) /* ckm0 - fCLK/2^9 */
#define _000A_TAU0_CKM0_fCLK_10               (0x000AU) /* ckm0 - fCLK/2^10 */
#define _000B_TAU0_CKM0_fCLK_11               (0x000BU) /* ckm0 - fCLK/2^11 */
#define _000C_TAU0_CKM0_fCLK_12               (0x000CU) /* ckm0 - fCLK/2^12 */
#define _000D_TAU0_CKM0_fCLK_13               (0x000DU) /* ckm0 - fCLK/2^13 */
#define _000E_TAU0_CKM0_fCLK_14               (0x000EU) /* ckm0 - fCLK/2^14 */
#define _000F_TAU0_CKM0_fCLK_15               (0x000FU) /* ckm0 - fCLK/2^15 */
...
*/
/* Timer output of channel 7 (TOMm7) */
...
/* Timer output of channel 6 (TOMm6) */
...
/* Timer output of channel 5 (TOMm5) */
...
/* Timer output of channel 4 (TOMm4) */
...
#define _0000_TAU_CH7_OUTPUT_DISABLE          (0x0000U) /* timer output is disabled */
#define _0080_TAU_CH7_OUTPUT_ENABLE           (0x0080U) /* timer output is enabled */
/* Timer output enable/disable of channel 6 (TOEm6) */
#define _0000_TAU_CH6_OUTPUT_DISABLE          (0x0000U) /* timer output is disabled */
#define _0040_TAU_CH6_OUTPUT_ENABLE           (0x0040U) /* timer output is enabled */
/* Timer output enable/disable of channel 5 (TOEm5) */
#define _0000_TAU_CH5_OUTPUT_DISABLE          (0x0000U) /* timer output is disabled */
#define _0020_TAU_CH5_OUTPUT_ENABLE           (0x0020U) /* timer output is enabled */
/* Timer output enable/disable of channel 4 (TOEm4) */
#define _0000_TAU_CH4_OUTPUT_DISABLE          (0x0000U) /* timer output is disabled */
#define _0010_TAU_CH4_OUTPUT_ENABLE           (0x0010U) /* timer output is enabled */
...
Macro definitions
***********************************************************************************************************************/
#define _EA5F_TAU_TDR00_VALUE                 (0xEA5FU) /* 16-bit timer data register 00 */
/* Clock divisor for TAU0 channel 0 */
#define TAU0_CHANNEL0_DIVISOR                 (2U)      /* fCLK/2 */
