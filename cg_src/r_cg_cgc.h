...
#define _00_CGC_CLK_ENABLE                        (0x00U) /* enables subsystem clock to peripheral functions */
#define _80_CGC_CLK_STOP                          (0x80U) /* stops subsystem clock to peripheral functions */
