...
/************************************************************************/
/* 関数     : cpu_com_send_start										*/
/* 関数名   : CPU間送信開始												*/
/* 引数     : なし														*/
/* 戻り値   : なし														*/
/* 変更履歴 : 2018.04.08  Axia Soft Design 西島		初版作成			*/
/*          : 2018.08.03  Axia Soft Design 西島		送信完了と分ける	*/
/************************************************************************/
/* 機能 : CPU間送信(終了まで)											*/
/************************************************************************/
/* 注意事項 :周期処理を介さずドライバレベルの送信開始まで本関数で行う	*/
/************************************************************************/
void cpu_com_send_start( void )
{
	/* アプリからデータ取得 */
	ds_get_cpu_com_order( &s_p_cpu_com_ds_order );
...
/************************************************************************/
/* 関数     : cpu_com_send_end_wait										*/
/* 関数名   : CPU間送信完了まで待つ										*/
/* 引数     : なし														*/
/* 戻り値   : なし														*/
/* 変更履歴 : 2018.08.03  Axia Soft Design 西島		初版作成			*/
/************************************************************************/
/* 機能 : CPU間送信完了まで待つ											*/
/************************************************************************/
/* 注意事項 :なし														*/
/************************************************************************/
void cpu_com_send_end_wait( void )
{
	while(1){
