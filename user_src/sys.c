...
/************************************************************************/
/* 関数     : di_ret													*/
/* 関数名   : マスカブル割り込み禁止(前回状態への復帰)					*/
/* 引数     : なし														*/
/* 戻り値   : なし														*/
/* 変更履歴 : 2018.08.28 Axia Soft Design 西島 稔	初版作成			*/
/************************************************************************/
/* 機能 :マスカブル割り込み禁止(前回状態への復帰)						*/
/************************************************************************/
/* 注意事項 : 															*/
/* ①前回状態への復帰となるため、かならず同一関数内で禁止/許可をセットで*/
/* 使用して下さい														*/
/************************************************************************/
void di_ret( void )
{
...
/************************************************************************/
/* 関数     : ei_ret													*/
/* 関数名   : マスカブル割り込み許可(前回状態への復帰)					*/
/* 引数     : なし														*/
/* 戻り値   : なし														*/
/* 変更履歴 : 2018.08.28 Axia Soft Design 西島 稔	初版作成			*/
/************************************************************************/
/* 機能 :マスカブル割り込み許可(前回状態への復帰)						*/
/************************************************************************/
/* 注意事項 : 															*/
/* ①前回状態への復帰となるため、かならず同一関数内で禁止/許可をセットで*/
/* 使用して下さい														*/
